    ...
    <div>
          ...
          <div className="specialities">
            <SpecialityCard
              props={{
                ...
                content:
                  "Proficient in managing repositories, and collaborating with teams to maintain efficient codebases.",
              }}
            />
            <SpecialityCard
              props={{
                ...
                content:
                  "Skilled in both frontend and backend development, creating seamless user experiences.",
              }}
            />
            <SpecialityCard
              props={{
                ...
                content:
                  "Beginner in automating workflows and deploying applications to ensure efficient operations.",
              }}
            />
          </div>
      ...
      {!isVisible && (
        <div className="screen">
          <div className="text">
            The screen is not large enough to view this page!
          </div>
        </div>
      )}
    </div>
